...
const Footer = () => {
  return (
    <>
      <div class="sc-1ryyl0a-1 Ghuwm">
        <footer class="sc-1ryyl0a-0 duxYwl">
          <div class="sc-1sojafr-0 hWCCxT">
            <div class="sc-1sojafr-1 iMXKCx">
              <img
                class="sc-1sojafr-6 bCFfMH lozad"
                src="https://web-images.credcdn.in/v2/_next/assets/images/landing/desktop/footer-logo.png"
                alt="cred logo"
                data-loaded="true"
              />
              <img
                class="sc-1sojafr-5 biUoey lozad"
                data-src="https://web-images.credcdn.in/v2/_next/assets/images/landing/security-final-2.png"
                alt="security logo"
                src="https://web-images.credcdn.in/v2/_next/assets/images/landing/security-final-2.png"
                data-loaded="true"
              />
              <div class="sc-1sojafr-8 dDPGkn">
                complete security. no asterisks.
              </div>
              <div class="sc-1sojafr-9 dshbKH">
                CRED encrypts all data and transactions to ensure a completely
                secure experience for our members.
              </div>
            </div>
            <div class="sc-1sojafr-12 dtEhqm">
              <div class="sc-1sojafr-15 biUVdo">
                <div class="sc-1sojafr-16 hlQyPr">now live</div>
                <img
                  src="https://web-images.credcdn.in/v2/_next/assets/images/launch-banners/money/now-live-wide.png?tr=q-95"
                  class="sc-1sojafr-17 hIVSUW"
                />
              </div>
              <div class="sc-1sojafr-4 eeTlTA">
                <div class="sc-1sojafr-2 gmVWof">
                  <div class="sc-1sojafr-3 iCNtsG">
                    <div class="sc-1sojafr-11 cSektw">UPGRADES</div>
                    <div class="sc-1sojafr-10 hRyylX">
                      <div>
                        <a
                          href="https://cred.club/money"
                          target="_blank"
                          class="sc-1sojafr-19 hOXrWh"
                        >
                          CRED money
                        </a>
                      </div>
                  ...
                  <div class="sc-1sojafr-3 iCNtsG">
                    <div class="sc-1sojafr-11 cSektw">PAYMENTS</div>
                    <div class="sc-1sojafr-10 hRyylX">
                      <div>
                        <a
                ...
                <div class="sc-1sojafr-2 gmVWof">
                  <div class="sc-1sojafr-3 iCNtsG">
                    <div class="sc-1sojafr-11 cSektw">COMPANY</div>
                    <div class="sc-1sojafr-10 hRyylX">
                      <div>
                        <a
                  ...
                  <div class="sc-1sojafr-3 iCNtsG">
                    <div class="sc-1sojafr-11 cSektw">INSIDER PERKS</div>
                    <div class="sc-1sojafr-10 hRyylX">
                      <div>
                        <a
                  ...
                  <div class="sc-1sojafr-3 iCNtsG">
                    <div class="sc-1sojafr-11 cSektw">DESIGN</div>
                    <div class="sc-1sojafr-10 hRyylX">
                      <div>
                        <a
                ...
                <div class="sc-1sojafr-2 gmVWof">
                  <div class="sc-1sojafr-3 iCNtsG">
                    <div class="sc-1sojafr-11 cSektw">RESOURCES</div>
                    <div class="sc-1sojafr-10 hRyylX">
                      <div>
                        <a
                  ...
                  <div class="sc-1sojafr-3 iCNtsG">
                    <div class="sc-1sojafr-11 cSektw">POLICY</div>
                    <div class="sc-1sojafr-10 hRyylX">
                      <div>
                        <a
          ...
          <div class="sc-1sojafr-14 hXmhLb">
            <div class="sc-1sojafr-13 dTTmuO"></div>
            <div class="sc-1sojafr-18 edGIvt">
              <div class="sc-1sojafr-21 hASeTI">
                copyright © 2020-24 Dreamplug Technologies Pvt Ltd.
              </div>
              <div class="sc-1sojafr-20 eEBJKd">
                <a
                  href="https://cred.club/privacy"
                  target="_blank"
                  class="sc-1sojafr-7 ItEkq"
                >
                  privacy policy
                </a>
                <a
