...
const HeroBanner = () => {
  return (
    <>
      <div className="sc-q224e2-0 hZioGK" data-testid="banner-container">
        <section className="sc-ddh18-2 sc-994i1z-0 gWQImb jmmmUm" data-testid="video-container">
        ...
        <div className="sc-q224e2-1 eNOzEi" data-testid="text-container">
          <div className="sc-q224e2-2 gPzscb">
            crafted for the
            <br />
            creditworthy
          </div>
          <div className="sc-q224e2-3 dsibsS">
            CRED is a members-only club that enables the
            <br />
            trustworthy to make financial progress
          </div>
          <div className="sc-q224e2-4 jaEGKO">
